...
import { Calendar, MapPin, Ticket, ExternalLink, CalendarPlus, Check, Star } from 'lucide-react';

// ---- モックデータ ----------------------------------------------------

const TEAMS = [
  { id: 'kashima',  name: '鹿島アントラーズ',   short: '鹿島',   color: '#A6093D', stadium: 'メルカリスタジアム',           coords: { lat: 35.9862, lng: 140.6412 }, ticketSystem: { name: 'Jリーグチケット', url: 'https://www.jleague-ticket.jp/club/ka/' } },
  { id: 'mito',     name: '水戸ホーリーホック', short: '水戸',   color: '#1E3A8A', stadium: 'ケーズデンキスタジアム水戸',   coords: { lat: 36.3745, lng: 140.4479 }, ticketSystem: { name: 'Jリーグチケット(クラブ一覧)', url: 'http://club.jleague-ticket.jp/schedule/index.html' } },
  { id: 'urawa',    name: '浦和レッズ',       short: '浦和',   color: '#C8102E', stadium: '埼玉スタジアム2002',       coords: { lat: 35.9040, lng: 139.7194 }, ticketSystem: { name: 'Jリーグチケット', url: 'https://www.jleague-ticket.jp/club/ur/' } },
  { id: 'chiba',    name: 'ジェフユナイテッド千葉', short: '千葉', color: '#002664', stadium: 'フクダ電子アリーナ',         coords: { lat: 35.6086, lng: 140.1235 }, ticketSystem: { name: 'Jリーグチケット', url: 'https://www.jleague-ticket.jp/club/je/' } },
  { id: 'kashiwa',  name: '柏レイソル',       short: '柏',     color: '#F5A623', stadium: '三協フロンテア柏スタジアム', coords: { lat: 35.9007, lng: 139.9264 }, ticketSystem: { name: 'Jリーグチケット', url: 'https://www.jleague-ticket.jp/club/kr/' } },
  { id: 'fctokyo',  name: 'FC東京',          short: 'FC東京', color: '#1B4A9C', stadium: '味の素スタジアム',           coords: { lat: 35.6653, lng: 139.5384 }, ticketSystem: { name: 'チケットFC東京(Jリーグチケット)', url: 'https://www.jleague-ticket.jp/club/to/' } },
  { id: 'verdy',    name: '東京ヴェルディ',   short: 'ヴェルディ', color: '#2E9E4C', stadium: '味の素スタジアム',       coords: { lat: 35.6653, lng: 139.5384 }, ticketSystem: { name: 'ヴェルディチケット(Jリーグチケット)', url: 'https://www.jleague-ticket.jp/club/vn/' } },
  { id: 'machida',  name: 'FC町田ゼルビア',   short: '町田',   color: '#14213D', stadium: '町田GIONスタジアム',         coords: { lat: 35.5433, lng: 139.4467 }, ticketSystem: { name: 'Jリーグチケット(クラブ一覧)', url: 'http://club.jleague-ticket.jp/schedule/index.html' } },
  { id: 'kawasaki', name: '川崎フロンターレ', short: '川崎F',  color: '#1D2088', stadium: '等々力陸上競技場',           coords: { lat: 35.5701, lng: 139.6573 }, ticketSystem: { name: 'Jリーグチケット', url: 'https://www.jleague-ticket.jp/club/kf/' } },
  { id: 'ynmarinos',name: '横浜F・マリノス', short: '横浜FM', color: '#0A2F6B', stadium: '日産スタジアム',             coords: { lat: 35.5089, lng: 139.6047 }, ticketSystem: { name: 'チケットF・マリノス(Jリーグチケット)', url: 'https://www.jleague-ticket.jp/club/ym/' } },
  { id: 'shimizu',  name: '清水エスパルス',   short: '清水',   color: '#F58220', stadium: 'IAIスタジアム日本平',        coords: { lat: 34.9752, lng: 138.3436 }, ticketSystem: { name: 'クラブ公式(パルチケ)', url: 'https://www.s-pulse.co.jp/tickets/schedule' } },
  ...
  { id: 'kyoto',    name: '京都サンガF.C.',  short: '京都',   color: '#8B1A2B', stadium: 'サンガスタジアム by KYOCERA', coords: { lat: 35.0122, lng: 135.5757 }, ticketSystem: { name: 'クラブ公式チケット', url: 'https://www.sanga-fc.jp/ticket' } },
  { id: 'gamba',    name: 'ガンバ大阪',       short: 'G大阪',  color: '#0057A8', stadium: 'パナソニックスタジアム吹田', coords: { lat: 34.7815, lng: 135.5225 }, ticketSystem: { name: 'Jリーグチケット', url: 'https://www.jleague-ticket.jp/club/go/' } },
  { id: 'cerezo',   name: 'セレッソ大阪',     short: 'C大阪',  color: '#E4007F', stadium: 'YANMAR HANASAKA STADIUM',   coords: { lat: 34.6108, lng: 135.5228 }, ticketSystem: { name: 'Jリーグチケット(クラブ一覧)', url: 'http://club.jleague-ticket.jp/schedule/index.html' } },
  { id: 'kobe',     name: 'ヴィッセル神戸',   short: '神戸',   color: '#7B0028', stadium: 'ノエビアスタジアム神戸',     coords: { lat: 34.6621, lng: 135.1758 }, ticketSystem: { name: '楽天チケット(クラブ公式)', url: 'https://vissel.tstar.jp/' } },
  { id: 'okayama',  name: 'ファジアーノ岡山', short: '岡山',   color: '#002B5C', stadium: 'Cityライトスタジアム',       coords: { lat: 34.6553, lng: 133.9195 }, ticketSystem: { name: 'Jリーグチケット(クラブ一覧)', url: 'http://club.jleague-ticket.jp/schedule/index.html' } },
  ...
  { id: 'fukuoka',  name: 'アビスパ福岡',     short: '福岡',   color: '#E8B800', stadium: 'ベスト電器スタジアム',       coords: { lat: 33.5544, lng: 130.4227 }, ticketSystem: { name: 'Jリーグチケット(クラブ一覧)', url: 'http://club.jleague-ticket.jp/schedule/index.html' } },
  { id: 'nagasaki', name: 'V・ファーレン長崎', short: '長崎',   color: '#0072BC', stadium: 'PEACE STADIUM Connected by SoftBank', coords: { lat: 32.7460, lng: 129.8730 }, ticketSystem: { name: '長崎スタジアムシティアプリ(要アプリDL)', url: 'https://www.v-varen.com/tickets_new' } },
];
...
// ---- 実際の対戦カード(試合日程のみ実データ、発売日はモック) -----------------
// 各クラブ公式サイトで発表された「2026/27明治安田J1リーグ 各節対戦カード」を
// 転記したもの。チケット発売日はまだ告知されていないため、既存のモック生成
// ロジック(近似式)で仮の日付を割り当てる。
// 取得日時: 2026-07-11 / 出典: 横浜F・マリノス公式サイト
const REAL_SCHEDULES = {
  ynmarinos: [
    { matchday: 1, isHome: true, opponentId: 'kashima', venueOverride: 'MUFG国立', date: '2026-08-07', kickoff: '19:30' },
    { matchday: 2, isHome: false, opponentId: 'shimizu', date: '2026-08-15' },
    { matchday: 3, isHome: true, opponentId: 'kobe', date: '2026-08-22' },
    { matchday: 4, isHome: false, opponentId: 'urawa', date: '2026-08-29' },
    { matchday: 5, isHome: true, opponentId: 'kyoto', date: '2026-09-02' },
    { matchday: 6, isHome: false, opponentId: 'kashiwa', date: '2026-09-05' },
    { matchday: 7, isHome: false, opponentId: 'machida', venueOverride: 'MUFG国立', date: '2026-09-12' },
    ...
    { matchday: 18, isHome: false, opponentId: 'gamba', date: '2026-12-05' },
  ...
  // 鹿島アントラーズ(8〜10月分、出典: soccer.phew.homeip.net 試合日程データ)
  kashima: [
    { matchday: 1, isHome: false, opponentId: 'ynmarinos', venueOverride: 'MUFGスタジアム', date: '2026-08-07', kickoff: '19:25' },
    { matchday: 2, isHome: true, opponentId: 'nagoya', date: '2026-08-15', kickoff: '18:00' },
    { matchday: 3, isHome: true, opponentId: 'fukuoka', date: '2026-08-22', kickoff: '18:00' },
    ...
    { matchday: 6, isHome: true, opponentId: 'urawa', date: '2026-09-06', kickoff: '18:00' },
    { matchday: 7, isHome: false, opponentId: 'kobe', date: '2026-09-12' },
    { matchday: 8, isHome: false, opponentId: 'kawasaki', date: '2026-09-19' },
    { matchday: 9, isHome: true, opponentId: 'gamba', date: '2026-10-10' },
    { matchday: 10, isHome: true, opponentId: 'nagasaki', date: '2026-10-17', kickoff: '15:00' },
    { matchday: 11, isHome: false, opponentId: 'kyoto', date: '2026-10-21', kickoff: '19:00' },
    { matchday: 12, isHome: true, opponentId: 'kashiwa', date: '2026-10-24', kickoff: '15:00' },
    { matchday: 13, isHome: true, opponentId: 'cerezo', date: '2026-10-31', kickoff: '15:00' },
  ],
  // 浦和レッズ(8〜10月分)
  urawa: [
    { matchday: 1, isHome: false, opponentId: 'gamba', date: '2026-08-07', kickoff: '19:30' },
    { matchday: 2, isHome: true, opponentId: 'hiroshima', date: '2026-08-15', kickoff: '19:00' },
    { matchday: 3, isHome: false, opponentId: 'machida', venueOverride: 'MUFGスタジアム', date: '2026-08-23', kickoff: '19:30' },
    { matchday: 4, isHome: true, opponentId: 'ynmarinos', date: '2026-08-29', kickoff: '19:00' },
    ...
    { matchday: 7, isHome: true, opponentId: 'okayama', date: '2026-09-13', kickoff: '18:30' },
    { matchday: 8, isHome: true, opponentId: 'verdy', date: '2026-09-19', kickoff: '18:30' },
    ...
    { matchday: 11, isHome: true, opponentId: 'chiba', date: '2026-10-21', kickoff: '19:30' },
    { matchday: 12, isHome: true, opponentId: 'nagasaki', date: '2026-10-25', kickoff: '15:00' },
  ...
  kashiwa: [
    ...
    { matchday: 2, isHome: false, opponentId: 'verdy', venueOverride: 'MUFGスタジアム', date: '2026-08-14', kickoff: '19:00' },
    ...
    { matchday: 8, isHome: false, opponentId: 'machida', date: '2026-09-20', kickoff: '17:00' },
  ...
  // ガンバ大阪(8〜10月分)
  gamba: [
    { matchday: 1, isHome: true, opponentId: 'urawa', date: '2026-08-07', kickoff: '19:30' },
    ...
    { matchday: 4, isHome: true, opponentId: 'hiroshima', date: '2026-08-29', kickoff: '18:00' },
    ...
    { matchday: 7, isHome: true, opponentId: 'fctokyo', date: '2026-09-12', kickoff: '19:00' },
    { matchday: 8, isHome: true, opponentId: 'kobe', date: '2026-09-20', kickoff: '17:00' },
    ...
    { matchday: 12, isHome: true, opponentId: 'kyoto', date: '2026-10-24', kickoff: '16:00' },
    { matchday: 13, isHome: false, opponentId: 'machida', date: '2026-10-31', kickoff: '14:00' },
  ],
  // 東京ヴェルディ(8〜10月分)
  verdy: [
    { matchday: 1, isHome: true, opponentId: 'kawasaki', date: '2026-08-09', kickoff: '18:00' },
    { matchday: 2, isHome: true, opponentId: 'kashiwa', venueOverride: 'MUFGスタジアム', date: '2026-08-14', kickoff: '19:00' },
...
// 試合日程は実データ・発売日はモック、という混在パターンを組み立てる汎用関数
function buildFixturesFromRealSchedule(team, schedule) {
  return schedule.map((entry) => {
    ...
    // チケット発売日は未告知のため、モックの近似ロジックで仮の日付を割り当てる
    const saleOffset = hashOffset(`${team.id}-${entry.matchday}`, 14, 20);
    ...
    return {
      ...
      isRealData: false, // 発売日はモックのため実データ扱いにはしない(試合日程自体は実データ)
      scheduleIsReal: true,
    };
  });
}
